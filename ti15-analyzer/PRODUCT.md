...
3. **先到 10 杀盯中单**：哪边先堆到 10 人头、当时中单出了几刀
4. **中辅联动**：先到 10 杀时中单+双辅合计；≥3 为中辅驱动

入口：`web/index.html`（与 `web/analysis.html` 相同）

关键本届画像见逐场页。口径已改为先到 10 杀，不再看收刀人。

## 6. 还差的确认

1. 有没有 Liquipedia v3 Key / STRATZ Token（有助攻日志的话，中辅联动能从「都出过刀」升级成真实协助）
